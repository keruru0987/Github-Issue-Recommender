...
def get_rel_list(api, so_body, so_title, so_tags):
    ...
    scores = s2v.score_all(tagged_data_process.process_query(so_body), so_title, so_tags)
...
if __name__ == '__main__':
    ...
    so_body = "<p>I want to analyze sentiment of texts that are written in German. " \
              "I found a lot of tutorials on how to do this with English, but I found none on how to apply it to different languages.</p>"
    so_title = "Sentiment analysis of non-English texts"
    so_tags = "<python><machine-learning><nlp><sentiment-analysis><textblob>"

    rel_list = get_rel_list(api, so_body, so_title, so_tags)
    score = calculate_AP(rel_list, api)
    print(score)